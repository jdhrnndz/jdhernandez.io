  ...
  return (
    <Link href={href}>
      <button className={`group relative z-20 ${bgClass} uppercase inline-block no-underline text-center tracking-widest font-[Lekton] font-extrabold py-2 px-5 outline outline-2 outline-asda-green m-1.5 overflow-hidden`}>
        <i className="absolute w-0 h-full bg-asda-green skew top-0 -left-6 -z-[1] transition-width duration-200 ease-in hover-fill group-hover:w-[150%]" />
        <i className="absolute w-0 h-full bg-celadon-green skew top-0 -left-6 -z-[2] transition-width duration-300 ease-in group-hover:duration-100 group-hover:ease-in-out group-hover:w-[150%]" />
